...
-- Dumping data for table vinyl_store.shipping_rates: ~6 rows (approximately)
/*!40000 ALTER TABLE `shipping_rates` DISABLE KEYS */;
INSERT INTO `shipping_rates` (`id`, `quantity`, `cost`, `description`) VALUES
	(1, 1, 4.00, 'standard'),
	(2, 2, 6.00, 'nightline direct'),
	(3, 3, 6.00, 'nightline direct'),
	(4, 4, 6.00, 'nightline direct'),
	(5, 5, 6.00, 'nightline direct'),
	(6, 6, 8.00, 'nightline direct');
